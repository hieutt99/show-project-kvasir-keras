...
def eval(model, train_generator, val_generator, test_generator):
	...
	testSetReveal(model = model, test_generator = test_generator)
	testSetReveal(model = model, test_generator = test_generator)

	model_evaluate(model = model,train_generator = train_generator, val_generator=val_generator, \
	test_generator = test_generator, batch_size = 8, train_size = 800, val_size = 100, test_size = 100,\
		pass_train = False)
